...
// scriem stringul cu litere mari in cazul in care admin-ul nu a facut-o
$rol = strtoupper($rol);
// interogare de insert
$sql_insert = "INSERT INTO denis_utilizatori (user_name, password, email, rol) VALUES ('$user_name', '$cod_passw', '$email', '$rol')";
